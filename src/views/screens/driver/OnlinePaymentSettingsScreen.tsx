    ...
    <View style={styles.container}>
      ...
      {loading ? <Loading message="Loading payment methods..." /> : (
        <ScrollView contentContainerStyle={styles.content}>
          ...
          {!methods.length && <View style={styles.empty}><MaterialCommunityIcons name="qrcode-plus" size={46} color={colors.textLight} /><Text style={styles.emptyTitle}>No online method yet</Text><Text style={styles.emptyText}>Add GCash, a bank account, or another method with its QR code.</Text></View>}
        </ScrollView>
      )}

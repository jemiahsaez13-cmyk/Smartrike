...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: colors.background }, header: { flexDirection: 'row', alignItems: 'center', paddingTop: layout.headerTop, paddingBottom: spacing.md, paddingHorizontal: spacing.sm, paddingRight: spacing.screen, backgroundColor: colors.surface, borderBottomWidth: 1, borderBottomColor: colors.borderLight }, back: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center' }, headerCopy: { flex: 1, minWidth: 0 }, title: { ...typography.h2, fontSize: 21 }, subtitle: { ...typography.bodySmall, color: colors.textSecondary }, filters: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: spacing.screen, paddingVertical: spacing.xs, backgroundColor: colors.surface, borderBottomWidth: 1, borderBottomColor: colors.borderLight }, filterTouch: { flex: 1, minWidth: 0, minHeight: 44, alignItems: 'center', justifyContent: 'center' }, filter: { width: '94%', minHeight: 34, paddingVertical: spacing.xs, alignItems: 'center', justifyContent: 'center', paddingHorizontal: spacing.xs, borderRadius: radius.md, borderWidth: 1, borderColor: 'transparent', backgroundColor: 'transparent' }, filterActive: { backgroundColor: colors.primaryLight, borderColor: colors.primary }, filterText: { textAlign: 'center', ...typography.labelSmall, fontSize: 11, color: colors.textSecondary }, filterTextActive: { color: colors.primary, fontWeight: '700' }, center: { flex: 1, alignItems: 'center', justifyContent: 'center' }, content: { paddingHorizontal: spacing.screen, paddingTop: spacing.md, paddingBottom: layout.contentBottom }, card: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.borderLight, borderRadius: radius.lg, padding: spacing.md, marginBottom: spacing.md }, cardTop: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, passenger: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, flex: 1, minWidth: 0 }, passengerCopy: { flex: 1, minWidth: 0 }, cardTitle: { ...typography.h3, fontSize: 16 }, date: { ...typography.bodySmall, color: colors.textMuted }, status: { borderRadius: radius.pill, paddingHorizontal: 9, paddingVertical: 5 }, statusText: { ...typography.labelSmall, fontSize: 10 }, amountRow: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, alignItems: 'baseline', justifyContent: 'space-between', marginTop: spacing.md }, amount: { ...typography.h2, color: colors.primary }, method: { ...typography.label, color: colors.textSecondary }, detail: { marginTop: spacing.md, padding: spacing.sm, backgroundColor: colors.surfaceAlt, borderRadius: radius.md }, detailLabel: { ...typography.labelSmall, color: colors.textMuted }, reference: { ...typography.label, color: colors.text, marginTop: 3 }, proofBtn: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, proofText: { ...typography.label, color: colors.primary }, reason: { ...typography.bodySmall, color: colors.error, padding: spacing.sm, backgroundColor: colors.errorLight, borderRadius: radius.sm }, actions: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.sm }, reject: { backgroundColor: colors.error, padding: spacing.sm, flex: 1, minHeight: 48, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.error, borderRadius: radius.md }, rejectText: { ...typography.button, color: '#fff', textAlign: 'center', flexShrink: 1 }, verify: { padding: spacing.sm, flex: 2, minHeight: 48, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primary, borderRadius: radius.md }, verifyText: { ...typography.button, color: '#fff', textAlign: 'center', flexShrink: 1 }, empty: { alignItems: 'center', paddingVertical: 70 }, emptyTitle: { ...typography.h3, marginTop: spacing.md }, emptyText: { ...typography.body, color: colors.textMuted, textAlign: 'center', marginTop: spacing.xs }, imageOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.92)', justifyContent: 'center', padding: spacing.lg }, imageClose: { position: 'absolute', top: layout.headerTop, right: spacing.lg, width: 48, height: 48, alignItems: 'center', justifyContent: 'center', zIndex: 2 }, proofImage: { width: '100%', height: '82%' },
});
